...
class SellsControllerTest < ActionController::TestCase
  ...
  test "should create sell" do
    assert_difference('Sell.count') do
      post :create, sell: { cantidad: @sell.cantidad, estado: @sell.estado, fecha_compra: @sell.fecha_compra, monto: @sell.monto, peso_final: @sell.peso_final, usuario_id: @sell.usuario_id }
    end
  ...
  test "should update sell" do
    patch :update, id: @sell, sell: { cantidad: @sell.cantidad, estado: @sell.estado, fecha_compra: @sell.fecha_compra, monto: @sell.monto, peso_final: @sell.peso_final, usuario_id: @sell.usuario_id }
    assert_redirected_to sell_path(assigns(:sell))
  end
